"""
Django settings for datacrud project.
...
if RENDER_EXTERNAL_HOSTNAME: #DEPLOY
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME) #DEPLOY
...
WSGI_APPLICATION = 'datacrud.wsgi.application'
